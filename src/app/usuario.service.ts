...
export class UsuarioService {
  ...
  setConsignar(numeroCuenta: String, valor: Number) : Observable<Respuesta> {
    this.urlUsuario = 'http://127.0.0.1:8080/banco/rest/controllers/transaccion/consignarTransaccion/' + numeroCuenta + '/' + this.loginSesion + '/' + valor;
